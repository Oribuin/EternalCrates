...
public class EnglishLocale implements Locale {
    ...
    public Map<String, Object> getDefaultLocaleValues() {
        return new LinkedHashMap<>() {{
            ...
            this.put("#12", "General Crate Messages");
            ...
            this.put("#13", "Argument Handler Messages");
