package xyz.oribuin.eternalcrates.nms.v1_16_R2;
...
public class NMSHandlerImpl implements NMSHandler {
    ...
    public Entity createClientsideEntity(Player player, Location loc, EntityType entityType) {
        ...
        EntityTypes<? extends net.minecraft.server.v1_16_R2.Entity> nmsEntityType = IRegistry.ENTITY_TYPE.get(CraftNamespacedKey.toMinecraft(entityType.getKey()));
    ...
    public ItemStack setString(ItemStack item, String key, String value) {
        final net.minecraft.server.v1_16_R2.ItemStack itemStack = CraftItemStack.asNMSCopy(item);
